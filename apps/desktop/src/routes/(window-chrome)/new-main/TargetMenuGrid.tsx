		...
		if (props.variant === "recording") {
			return (
				<EmptyState
					...
					title={t("recording.noRecordingsYet")}
					description={t("recording.noRecordingsDescription")}
					action={
						onViewAll
							? { label: t("recording.viewAllRecordings"), onClick: onViewAll }
							: undefined
					}
				/>
			);
		...
		if (props.variant === "screenshot") {
			return (
				<EmptyState
					...
					title={t("recording.noScreenshotsYet")}
					description={t("recording.noScreenshotsDescription")}
					action={
						onViewAll
							? { label: t("recording.viewAllScreenshots"), onClick: onViewAll }
							: undefined
					}
				/>
			);
			...
			<div class="col-span-2 py-6 text-sm text-center text-gray-11">
				{props.emptyMessage ??
					(props.variant === "display"
						? t("recording.noDisplaysFound")
						: t("recording.noWindowsFound"))}
			</div>
		);
	};
									...
									<>
										...
										<Show when={recordingProps.onViewAll}>
											{(onViewAll) => (
												<ViewAllButton
													onClick={onViewAll()}
													label={t("recording.viewAllRecordings")}
												/>
											)}
										</Show>
									</>
									...
									<>
										...
										<Show when={screenshotProps.onViewAll}>
											{(onViewAll) => (
												<ViewAllButton
													onClick={onViewAll()}
													label={t("recording.viewAllScreenshots")}
												/>
											)}
										</Show>
									</>
